...
The Veritas MKII guide. Very flexible, as you can change out the head and roller for the right one for the job. Here you can see the vertical clamp above, best for larger irons. And the side clamp below. Best for narrow blades. You can also get a setup jig for handling skew irons.
